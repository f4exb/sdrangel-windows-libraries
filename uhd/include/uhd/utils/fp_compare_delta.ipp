...
template <>
UHD_INLINE fp_compare_delta<float>::fp_compare_delta(float value)
{
    _value = value;
...
template <>
UHD_INLINE fp_compare_delta<double>::fp_compare_delta(double value)
{
    _value = value;
...
template <typename float_t>
UHD_INLINE fp_compare_delta<float_t>::fp_compare_delta(float_t value, float_t delta)
    : _value(value), _delta(delta)
{ /* NOP */
}

template <typename float_t>
UHD_INLINE fp_compare_delta<float_t>::fp_compare_delta(
    const fp_compare_delta<float_t>& copy)
    : _value(copy._value), _delta(copy._delta)
{ /* NOP */
}
...
template <typename float_t>
UHD_INLINE void fp_compare_delta<float_t>::operator=(
    const fp_compare_delta<float_t>& copy)
{
    _value = copy._value;
    _delta = copy._delta;
...
{
    float_t delta =
        float_t(fp_compare_select_delta(double(lhs._delta), DOUBLE_PRECISION_DELTA));
...
{
    float_t delta = fp_compare_select_delta(DOUBLE_PRECISION_DELTA, double(rhs._delta));
...
{
    float_t delta =
        float_t(fp_compare_select_delta(DOUBLE_PRECISION_DELTA, double(rhs._delta)));
