...
UHD_API uhd_error uhd_meta_range_push_back(
    uhd_meta_range_handle h, const uhd_range_t* range);

//! Get the range at the given index
UHD_API uhd_error uhd_meta_range_at(
    uhd_meta_range_handle h, size_t num, uhd_range_t* range_out);
...
UHD_API uhd::range_t uhd_range_c_to_cpp(const uhd_range_t* range_c);

UHD_API void uhd_range_cpp_to_c(const uhd::range_t& range_cpp, uhd_range_t* range_c);
#endif
